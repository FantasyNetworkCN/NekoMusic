      ...
      <div v-else class="download-sections">
        ...
        <div class="pc-section">
          ...
          <div class="platform-downloads">
            <!-- Windows -->
            <a :href="versionInfo.pc?.windows || versionInfo.pc?.downloadUrl || versionInfo.updateUrl" class="platform-btn" download>
            ...
            <!-- Linux -->
            <a :href="versionInfo.pc?.Linux" class="platform-btn" download>
            ...
            <!-- macOS -->
            <a :href="versionInfo.pc?.mac" class="platform-btn" download>
              <svg class="platform-icon" viewBox="0 0 24 24" fill="currentColor">
