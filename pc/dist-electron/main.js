  ...
  try {
    ...
    try {
      ...
      if (console.log("歌词响应状态:", L.status), L.ok) {
        ...
        console.log("歌词数据:", x), x.success && x.data ? (b = d.join(r, `${w}.lrc`), h.writeFileSync(b, x.data, "utf-8"), console.log("歌词文件保存成功:", b)) : console.log("没有歌词数据");
      } else
        console.log("歌词不可用");
    } catch (k) {
